...
// 	// **Add Subject Element directly in summaryBox**
// 	const subjectContent = document.createElement('p'); // Element to hold subject

// 	// Mail summary section
// 	const mailSummary = document.createElement('div');
// 	mailSummary.className = 'mail-summery';
// 	const summaryParagraph = document.createElement('p'); // Renaming to avoid confusion with subjectContent
...
// 	summaryBox.appendChild(subjectContent); // **Add Subject Element to summaryBox - before summary**
...
// 			const subjectContentElement = document.querySelector('.summery-box h2'); // Get the subject content element (within summery-box)

// 			// Show loading state
// 			summaryParagraph.textContent = 'Loading email content...'; // Loading for summary paragraph
// 			subjectContentElement.textContent = 'Loading subject...'; // Indicate loading for subject too
...
// 			setTimeout(() => {
// 				const emailSubject = getEmailSubject(emailItem);
// 				const emailContent = getEmailContent();
// 				updateSummary(emailSubject, emailContent);
// 			}, 500);
// 		}
// 	});
// }
...
// // Modified updateSummary to display subject in the new element within summery-box
// function updateSummary(emailSubject, emailContent) {
// 	const summaryParagraph = document.querySelector('.mail-summery p'); // Correctly target summary paragraph
// 	const actionList = document.querySelector('.action-items ul');
// 	const subjectContentElement = document.querySelector('.summery-box h2'); // Get subject element from summery-box

// 	// Display email subject in the subject element
// 	subjectContentElement.textContent = emailSubject || 'No Subject'; // Display subject, or default message if not available

// 	// Display raw email content in the summary paragraph (below subject)
// 	summaryParagraph.textContent = emailContent || 'No email content found';
